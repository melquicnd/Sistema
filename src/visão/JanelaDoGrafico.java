...
public class JanelaDoGrafico extends javax.swing.JFrame {
    ...
    public JanelaDoGrafico() {
        ...
        listaDePessoas.add(new Pessoa("Jurandir", 55));
        listaDePessoas.add(new Pessoa("Marcos", 80));
        listaDePessoas.add(new Pessoa("diogo", 90));
        listaDePessoas.add(new Pessoa("Douglas", 67));
        listaDePessoas.add(new Pessoa("henrique", 30));
